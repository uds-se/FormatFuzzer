...
`also allow <http://www.sweetscape.com/010editor/manual/TemplateVariables.htm>`_
...
.. automodule:: pfp.native.watchers
   :members:
...
packers work just fine (see the :any:`PackerGZip <pfp.native.packers.packer_gzip>` packer for
an example).
