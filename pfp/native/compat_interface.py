...
def AddBookmark(params, ctxt, scope, stream):
	pass

#void ClearClipboard()
@native(name="ClearClipboard", ret=pfp.fields.Void)
def ClearClipboard(params, ctxt, scope, stream):
	pass
...
def FileOpen(params, ctxt, scope, stream):
	pass
...
def FileSave(params, ctxt, scope, stream):
	pass
...
def InputOpenFileName(params, ctxt, scope, stream):
	pass
...
def InputOpenFileNames(params, ctxt, scope, stream):
	pass
...
def InputRadioButtonBox(params, ctxt, scope, stream):
	pass
...
def InputSaveFileName(params, ctxt, scope, stream):
	pass
...
def InputString(params, ctxt, scope, stream):
	pass
